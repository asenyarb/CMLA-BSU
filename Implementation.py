...
if __name__ == "__main__":
    ...
    print("\nInitial matrix:")
    print_matrix(initial_matrix, free_terms_vector=free_terms)
    ...
    print("\nTransformed matrix:")
    print_matrix(transformed_matrix, free_terms_vector=transformed_free_terms)
    ...
    for index in range(len(incoherence_matrix)):
        print("dx[%d] = " % index, incoherence_matrix[index])
